...
class IS590PR:
    ...
    def __init__(self, student_exp)
    # particiaption, quizzes, group_assign, ind_assign, final_proj, grade): # list our functions once they are created
...
def quizzes(num_quiz):
    ...
    for quizzes in range(1, num_quiz):
        ...
        if quiz_1 == 100:
            ...
            quiz_2 = random.randint(quiz_1, 100)
